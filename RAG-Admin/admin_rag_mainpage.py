...
sys.path.insert(4, 'C:/AI/Work/Common/Admin')
...
createdb_page     = st.Page("C:/AI/Work/Common/Admin/settingsRAG.py", title="Создать RAG базу", icon=":material/add_circle:")
...
if st.session_state.logged_in==0:
    pg = st.navigation(
        {
            "Настройка":         [settings_page, usersettings_page, createdb_page],
